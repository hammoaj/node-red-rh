...
var baseDir = process.env.NODE_RED_HOME || __dirname;
// var userDir = path.join(baseDir, ".node-red");
...
var settings = {
    ...
    nodesDir: path.join(baseDir,"nodes"),

    // Blacklist the non-IBM Cloud friendly nodes
...
if (process.env.NODE_RED_STORAGE_URL) {
    ...
    settings.cloudantService = {
        ...
        name: "Cloudant",
        // The URL to use
        url: process.env.NODE_RED_STORAGE_URL,
